...
const BLOCKS = [
  ...
  {
    title: "Backend",
    subtitle: "APIs, services, and real-time systems",
    icon: "🧩",
    skills: [
      "Node.js",
      "Express.js",
  ...
  },
  {
    ...
    subtitle: "Data modeling and secure access",
    icon: "🗄️",
    skills: [
      "MongoDB",
      "PostgreSQL",
  ...
  },
  {
    ...
    subtitle: "Shipping and running in production",
    icon: "🚀",
    skills: [
      "Git",
      "GitHub",
  ...
  },
  {
    ...
    subtitle: "Commerce, integrations, and design",
    icon: "💼",
    skills: [
      "Shopify",
      "API Integrations",
  ...
  {
    title: "Hardware & IoT",
    subtitle: "Embedded systems and prototyping",
    icon: "🛠️",
    skills: [
      "Arduino",
      "ESP32",
